...
Generated TypeScript interfaces and a `TypeMap` for EnergyPlus 9.4.0.
...
```bash
npm install --save-dev @idfkit/types-v9-4
```

```ts
import { loadIdf } from '@idfkit/core/node';
import type { TypeMap } from '@idfkit/types-v9-4';
