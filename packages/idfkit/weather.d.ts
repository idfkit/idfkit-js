// The honest declaration: `@idfkit/idfkit/weather` is `@idfkit/weather`, whole.
//
// @idfkit/weather is an OPTIONAL peer dependency. Installing `@idfkit/idfkit` does not
// install it, so this re-export is unresolvable until it is added:
//
//     npm install @idfkit/weather
//
// TypeScript only reads this file when something imports `@idfkit/idfkit/weather`, so a
